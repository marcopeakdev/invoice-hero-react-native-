...
type Props = {
  route: RouteProp<MainStackParamList, MainStackRouteNames.AddExpenseSingleItem>;
  navigation: NativeStackNavigationProp<MainStackParamList, MainStackRouteNames.AddExpenseSingleItem>;
};
...
export const AddExpenseSingleItem: React.FC<Props> = ({ route, navigation }) => {
  ...
  const onSave = (values: any) => {
    ...
    if (route.params?.expenseId) {
      ...
      if (_expenseItem) {
        realm.write(() => {
          _expenseItem['items'] = [...tempItems.map((item) => ({
          ...
          _expenseItem['purpose'] = 'This is test purpose';
          console.log(_expenseItem);
        });
      }
    }
    navigation.goBack();
